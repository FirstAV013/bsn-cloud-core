        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    uploadJob = main_1.cmCreateBsnUploadJob('TestJob', uploadJobSpecs, null, progressHandler);
...
var fileToUpload = isomorphicPath.resolve('./examples/testMedia/images/Ecuador Flower.jpg');
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 8]);
                    return [4, uploadLocalFile(fileToUpload, '/Shared/')];
                case 1:
                    uploadResult = _a.sent();
                    fileResult = uploadResult.fileUploadResults[0];
                    if (!fileResult.error) return [3, 2];
                ...
                case 2:
                    ...
                    console.log(util_1.inspect(fileResult, { depth: null, colors: true }));
                    console.log('Deleting file ...');
                    return [4, main_1.bsnGetSession().deleteContentItem(fileResult.assetItem.networkId)];
                case 3:
                    _a.sent();
...
doUploadLocalFile();
//# sourceMappingURL=uploadContentToBsn.js.map