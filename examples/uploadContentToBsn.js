...
try {
    ...
    console.log(
        "There must be a credentials.json file in the /examples directory with valid BSN credentials"
    );
}
function progressHandler(progress) {
    console.log(
        ...
        progress.totalItems,
        "files completed,",
        (progress.totalProgressFraction * 100).toFixed(2),
        "percent complete"
    );
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    uploadJob = (0, main_1.cmCreateBsnUploadJob)(
                        "TestJob",
                        uploadJobSpecs,
                        null,
                        progressHandler
                    ...
                    return [
                        4 /*yield*/,
                        (0, main_1.bsnGetSession)().activate(
                            credentials.user,
                ...
                case 2:
                    ...
                    if (checkResult.hasDuplicates) {
                        console.log(
                            "There are duplicate file names. Some file names will be changed."
                        );
                    }
...
var fileToUpload = isomorphicPath.resolve(
    "./examples/testMedia/images/flower.jpg"
);
function doUploadLocalFile() {
    return __awaiter(this, void 0, void 0, function () {
        var uploadResult, fileResult, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 7]);
                    return [
                        4 /*yield*/,
                        uploadLocalFile(fileToUpload, "/Shared/testlieke"),
                    ];
                case 1:
                ...
                case 2:
                    ...
                    console.log(
                        "Upload time:",
                        (new Date().getTime() -
                            uploadResult.startTime.getTime()) /
                            1000,
                        "seconds"
                    );
                    console.log(
                        (0, util_1.inspect)(fileResult, {
                            depth: null,
                            colors: true,
                        })
                    );
